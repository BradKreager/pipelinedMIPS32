...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/sources/Constraints/mips_fpga.xdc"]" -objects $obj
set_property -name "target_part" -value "xc7a35tcpg236-1" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/sources/Constraints/mips_fpga.xdc"]" -objects $obj
