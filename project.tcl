...
#
# Generated by Vivado on Sun May 05 14:28:50 -0700 2019
...
set remote_files [add_files -fileset sources_1 $files]
...
set file "$origin_dir/sources/Constraints/system_fpga.xdc"
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/sources/Constraints/system_fpga.xdc"]" -objects $obj
set_property -name "target_part" -value "xc7a35tcpg236-1" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/sources/Constraints/system_fpga.xdc"]" -objects $obj
